    ...
    <div className="animate-fade-in px-4 md:px-6 py-10 max-w-screen-lg mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-12 pb-12 border-b border-border">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider px-2 py-1 border border-primary/30 text-primary bg-primary/5">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <VerifBadge done={true} label="Email Verified" />
      ...
      <section className="mb-12">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 border border-border bg-card">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider text-primary px-2 py-1 border border-primary/20 bg-primary/5">
              Verified
            </span>
          </div>
